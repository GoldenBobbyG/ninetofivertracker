...
import { client } from './src/connection.js';
...
function addDepartment() {
    inquirer
        ...
        .then((answer) => {
            client.query('INSERT INTO department (name) VALUES ($1)', [answer.name], function (err, res) {
                if (err) throw err;
...
function addRole() {
    client.query('SELECT * FROM department', function (err, res) {
        ...
        inquirer
            ...
            .then((answers) => {
                client.query('INSERT INTO role (title, salary, department_id) VALUES ($1, $2, $3)', [answers.title, answers.salary, answers.department_id], function (err, res) {
                    if (err) throw err;
    ...
    client.query('SELECT * FROM role', function (err, res) {
        ...
        client.query('SELECT * FROM employee', function (err, res) {
            ...
            inquirer
                ...
                .then((answers) => {
                    client.query('INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4)', [answers.first_name, answers.last_name, answers.role_id, answers.manager_id], function (err, res) {
                        if (err) throw err;
    ...
    client.query('SELECT * FROM employee', function (err, res) {
        ...
        client.query('SELECT * FROM role', function (err, res) {
            ...
            inquirer
                ...
                .then((answers) => {
                    client.query('UPDATE employee SET role_id = $1 WHERE id = $2', [answers.role_id, answers.employee_id], function (err, res) {
                        if (err) throw err;
